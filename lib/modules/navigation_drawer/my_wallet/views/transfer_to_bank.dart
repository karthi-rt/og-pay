      ...
      child: FormBuilder(
        ...
        child: Column(
          ...
          children: [
            ...
            AppTextField(name: "Name", hint: "Enter full name", borderRadius: 36, keyboardType: TextInputType.name, textInputAction: TextInputAction.next, padding: EdgeInsets.symmetric(vertical: 0),),
            UIHelper.verticalSpaceM,
            AppText("Account Number", color: c.textPrimary, fontSize: 14, fontWeight: FontWeight.w600,),
            AppTextField(name: "Account Number", hint: "Enter account number", borderRadius: 36, keyboardType: TextInputType.number, textInputAction: TextInputAction.next, padding: EdgeInsets.symmetric(vertical: 0),),
            UIHelper.verticalSpaceM,
            AppText("SORT Code", color: c.textPrimary, fontSize: 14, fontWeight: FontWeight.w600,),
            AppTextField(name: "SORT Code", hint: "Enter SORT sode number", borderRadius: 36, keyboardType: TextInputType.text, textInputAction: TextInputAction.next, padding: EdgeInsets.symmetric(vertical: 0),),
            UIHelper.verticalSpaceM,
            AppText("Transfer Amount", color: c.textPrimary, fontSize: 14, fontWeight: FontWeight.w600,),
            AppTextField(name: "Transfer Amount", hint: "Enter amount here", borderRadius: 36, keyboardType: TextInputType.number, textInputAction: TextInputAction.next, padding: EdgeInsets.symmetric(vertical: 0),),
            UIHelper.verticalSpaceM,
            AppText("Purpose", color: c.textPrimary, fontSize: 14, fontWeight: FontWeight.w600,),
            AppTextField(name: "Purpose", hint: "What's this for?", borderRadius: 36, keyboardType: TextInputType.text, textInputAction: TextInputAction.done, padding: EdgeInsets.symmetric(vertical: 0),),
            UIHelper.verticalSpaceXXXL,
            AppButton(
